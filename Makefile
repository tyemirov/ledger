...
UNIT_TEST_PACKAGES := $(shell go list ./... | grep -v github.com/MarkoPoloResearchLab/ledger/internal/demobackend)
INTEGRATION_TEST_PACKAGES := github.com/MarkoPoloResearchLab/ledger/internal/demobackend
